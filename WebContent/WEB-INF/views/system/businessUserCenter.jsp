...
<body>
    ...
    <c:if test="${vo.orgType >3 and vo.orgType<9}">
    	...
    	<div class="grid_summay_opts" id="btns">
				<div class="left_opts">
						<a hideFocus="true" href="javascript:add('<%=basePath%>businessUser/eidt.htm?orgCode=${vo.orgCode}&orgType=1')" class="gray_radiu_btn" >
							<em class="gray_l"></em> 
							<em class="gray_r"></em> 
							新增
						</a>
        ...
        <div class="rightMenu bodyMenu Js_tdMenu">
            ...
            <ul>
                ...
                <li><a hideFocus="true" href="javascript:disRole()">分配商户权限</a></li>
                <!--  
	...
	<script type="text/javascript">
		...
		function highQuery()
		{
			...
			var returnVal = '<%=basePath%>businessUser/list.htm?orgCode=${vo.orgCode}&code=1';
		...
		function disRole()
		{
			...
			var selectId = data.idStr;
			// 明细弹出框
			var commonDialog = commonOpenDialog("readDetail",'分配商户权限',700,450, '<%=basePath %>userrole/rightTree.htm?orgCode=${orgCode}&id=' + selectId,null);
