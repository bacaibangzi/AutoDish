...
<title>组织机构修改</title>
	...
	<body>
		<div  class="form-mod">
			<form:form commandName="form" id="form" action="../org/save.htm?orgType=1" method="post">
				...
				<input type="hidden" name="code1" value="${vo.code1 }" />
				...
				<tbody>
					...
					<tr>
						...
						<td >
						<form:input path="areaName"  cssClass="input-text {required: true, maxlength: 60}"  readonly="readonly"/>
		...
		<script type="text/javascript">
		    ...
		    function submitCheck(){
			    ...
			    if(entityId!=""&&oiType==4&&orgType!=4){
				    ...
				    $.ajax({
					    url:"<%=basePath%>org/checkOiType.htm",
					    type:"post",
					    async: false,
