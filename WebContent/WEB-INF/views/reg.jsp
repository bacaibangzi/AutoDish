...
<div>
    ...
    <div class="regForm">
        ...
        <div class="regRow" style="height:20px;">
            <div class="leftCell">
                <label>
                    	邮箱：</label><input id="txtEmail"  onfocus="if(value==defaultValue){value='';this.style.color='#000'}" onblur="if(!value){value=defaultValue;this.style.color='#999'}" style=" color:#999" type="text" maxlength="64" name="txtEmail"  /></div>
            
            <div id="chktxtEmail" class="rightCell">请输入邮箱
            </div>
        </div>
          <div class="regRow" style="height:20px;">
            <div class="leftCell">
