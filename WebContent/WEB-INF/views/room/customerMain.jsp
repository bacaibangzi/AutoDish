...
<body>
    ...
    <div class="contenbox">
    	<div class="grid_summay_opts" id="btns">
				<!-- 
				<div class="left_opts">
						<a hideFocus="true" href="javascript:add('<%=basePath%>customer/eidt.htm?orgCode=${sessionScope.accountInfo.orgCode}')" class="gray_radiu_btn" >
							<em class="gray_l"></em> 
							<em class="gray_r"></em> 
							审核
						</a> 
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			var tableObj={}
			tableObj.url="<%=basePath%>customer/list.htm?orgCode=${sessionScope.accountInfo.userId}";
			...
			tableObj.aoColumns=[
				...
				{"mDataProp":"tel","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
				{"mDataProp":"sfz","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
				{"mDataProp":"date","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
				{"mDataProp":"loudong","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
				{"mDataProp":"louceng","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
				{"mDataProp":"room","sDefaultContent": "","bSortable":false,"sClass":"text-align-mid","sWidth":"100"},
		...
		function update() {
			...
			window.location = "<%=basePath%>customer/eidt.htm?entityId="+selectId; 
		...
		function detail() {
			...
			var selectId = data.idStr;
			// 明细弹出框
			var commonDialog = commonOpenDialog("readDetail",'详细',700,450, '<%=basePath%>customer/detail.htm?entityId=' + selectId);
		...
		function highQuery() {
			// 查询条件 区域名称
			var areaName_filter = '';
			var returnVal = '<%=basePath%>customer/list.htm?orgCode=${sessionScope.accountInfo.orgCode}';
			if(areaName_filter!=''){
		...
		function deleteAll() { 
			...
			if(rows.length!=1){
				...
				var rows=getSeleteObjs(datatable);
				var actionUrl = "<%=basePath%>customer/delete.htm?code=${vo.code}&entityIds=";
