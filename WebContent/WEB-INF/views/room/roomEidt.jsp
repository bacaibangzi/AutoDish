...
<title>房间编辑</title>
	...
	<body style="background:transparent">
		<div  class="form-mod">
			<form:form commandName="form" id="form" action="../room/save.htm" method="post">
				...
				<tbody>
					<tr>	
						...
						<td >
							<form:input path="code"  cssClass="input-text {required: true, maxlength: 32}"/>
						</td>
					</tr>
					...
					<tr>
						...
						<td >
							<form:input path="lockCode" cssClass="input-text {required: true, maxlength: 32}"/> 
						</td>
					</tr>
					...
					<tr>
						...
						<td >
							<form:input path="remark" cssClass="input-text {maxlength: 32}"/> 
						</td>
					</tr>
				</tbody>
				<tfoot>
