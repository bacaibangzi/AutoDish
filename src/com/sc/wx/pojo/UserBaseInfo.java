...
public UserBaseInfo(int subscribe, String openid, String nickname,
		int sex, String language, String city, String province,
		String country, String headimgurl, long subscribe_time, String unionid) {
	super();
	this.subscribe = subscribe;
	this.openid = openid;
	this.nickname = nickname;
...
public String toString() {
	return "UserBaseInfo [subscribe=" + subscribe + ", openid=" + openid
